    ...
    Vue.component("chattingArea", {
        ...
        template: `
            <div class="chat-area" v-bind:class="{'is-hidden': !show}">
                ...
                <div>
                    <visitor-chat-header v-if="chat != null" :closedChatView="closedChatView" ></visitor-chat-header>
                    <team-chat-Header v-if="user != null" :user="user"></team-chat-Header>

                    <visitor-chat-tabs v-if="chat != null" :closedChatView="closedChatView"></visitor-chat-tabs>
                    <team-chat-tabs v-if="user != null"></team-chat-tabs>
                </div>
                <visitor-chat-tab-content v-if="chat != null" :closedChatView="closedChatView"></visitor-chat-tab-content> 
